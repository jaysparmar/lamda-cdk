...
export const handler = async (event) => {
    ...
    try {
        ...
        const extension = originalImagePath.split('.').pop().toLowerCase();
        const defaultImages = {
            'jpg': cloudfrontUrl + '/default-jpg.jpg',
            'jpeg': cloudfrontUrl + '/default-jpg.jpg',
            'png': cloudfrontUrl + '/default-png.png',
            'gif': cloudfrontUrl + '/default-gif.gif',
        };

        const defaultUri = defaultImages[extension] || defaultImages['jpg'];
        ...
        try {
            ...
            const originalImageBody = await response.arrayBuffer();
            const content = new Uint8Array(originalImageBody);
